...
const listOrdersSchema = new Schema({
    ...
    customerUsername: { type: Number },
    customerEmail: { type: Number },
    ...
    holdUntilDate: { type: String },


    weight: { type: Object },
    dimensions: { type: Object },
    insuranceOptions: { type: Object },
    internationalOptions: { type: Object },
    advancedOptions: { type: Object },

    tagIds: { type: String },
    userId: { type: String },
    externallyFulfilled: { type: Boolean },
    externallyFulfilledBy: { type: String },
    labelMessages: { type: String },

    dateCreated: { type: Date, default: Date.now() },
    dateModified: { type: Date, default: Date.now() }
});

module.exports = mongoose.model('ListOrdersSchema', listOrdersSchema, 'ListOrdersSchema');
